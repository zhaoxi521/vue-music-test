        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="onProgressPercent"></progress-bar>
            </div>
  ...
  export default {
    ...
    methods: {
      ...
      handleLyric({lineNum, txt}) {
        ...
        if (lineNum > 5) {
          let currentEle = this.$refs.lyricLine[lineNum - 5]
          this.$refs.lyricList.scrollToElement(currentEle, 1000)
        } else {
